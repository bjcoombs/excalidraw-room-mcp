...
|--------|-------|
| LOC | 74 |
| Cyclomatic complexity (file max) | 10.0 |
...
|----------|-----|-----|---------|--------|
| 2026-09-08 | 74 | 10.0 | 1 | persistent |

## Briefing for editing this file

Use this briefing when about to modify `src/firebase.ts`:

Hotspot (persistent). 74 LOC, max cyclomatic complexity 10.0, 1 commits in churn window. (Briefing refined by LLM via assess_finalize - see Suggested actions below.)
