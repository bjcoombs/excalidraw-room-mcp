...
|--------|-------|
| LOC | 57 |
| Cyclomatic complexity (file max) | 8.0 |
...
|----------|-----|-----|---------|--------|
| 2026-09-08 | 57 | 8.0 | 1 | persistent |

## Briefing for editing this file

Use this briefing when about to modify `src/crypto.ts`:

Hotspot (persistent). 57 LOC, max cyclomatic complexity 8.0, 1 commits in churn window. (Briefing refined by LLM via assess_finalize - see Suggested actions below.)
